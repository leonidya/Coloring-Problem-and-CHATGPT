...
Can ChatGPT agents solve problem, when they are not related to each othe and each of them will receive specifi part of information to solve this proble.   
